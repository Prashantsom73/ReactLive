...
export class News extends Component {
  ...
  // componentmound
   ...
   updateNews  =async()=>{
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.props.apikey.toString()}&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    console.log("render");
    console.log(this.props.apikey.toString());
    return (
